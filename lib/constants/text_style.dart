...
class FontStyleText{
  ...
  static TextStyle text12W400LightBlack = TextStyle(color: TaskColors.lightBlackColor,fontSize: 12,fontWeight: FontWeight.w400);
  static TextStyle text14W400LightBlack = TextStyle(color: TaskColors.lightBlackColor,fontSize: 14,fontWeight: FontWeight.w400);
  static TextStyle text14W400Hint = TextStyle(color: TaskColors.hintColor,fontSize: 14,fontWeight: FontWeight.w400);
  static TextStyle text14W500White = TextStyle(fontWeight: FontWeight.w500,color: Theme.of(navigatorKey.currentContext!).backgroundColor,fontSize: 14);
